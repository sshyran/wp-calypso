			...
			},
			{
				...
				use: [
					...
					'css-loader',
					{
						...
						options: {
							plugins: [
								require( './vendor/gutenberg/packages/postcss-themes' )( {
									defaults: {
										primary: '#0085ba',
										secondary: '#11a0d2',
										toggle: '#11a0d2',
	...
	resolve: {
		...
		alias: Object.assign(
			...
			},
			{
				...
				'@wordpress/api-request': path.resolve(__dirname, 'vendor/gutenberg/packages/api-request' ),
				...
				'@wordpress/usersettings': path.resolve( __dirname, 'vendor/gutenberg/packages/usersettings' ),
			},
